...
<div id="content">
	...
	<?php while (have_posts()) : the_post(); ?>
		<div class="post" id="post-<?php the_ID(); ?>">
			...
			<div class="post-details"> <h3>Posted <?php $elixir->timesince() ?> ago. </p><a href="<?php the_permalink() ?>#comments"><?php comments_number('Add a comment','1 comment','% comments'); ?></a></h3></div>
